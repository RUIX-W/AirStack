...
# Compare:
# 1. Package structure
ls -la robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/
ls -la robot/ros_ws/src/autonomy/3_local/b_planners/your_planner/
...
- **ROS 2 Debugging:**
  - [ROS 2 Troubleshooting](https://docs.ros.org/en/humble/How-To-Guides/Troubleshooting.html)
...
- **GDB:**
  ...
  - [Debugging with GDB](https://docs.ros.org/en/humble/Tutorials/Debugging/Debugging-CPP.html)
