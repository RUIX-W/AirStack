...
### DROAN Local Planner
Disparity-space representation for obstacle avoidance. See [DROAN Local Planner](../../../robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/README.md).

### Your Module Name
Brief one-sentence description of your module.
- **Type:** Local planner
- **Purpose:** Specific use case
- **Documentation:** [Your Module README](../../../robot/ros_ws/src/autonomy/3_local/b_planners/your_package/README.md)
...
- **AirStack:**
  ...
  - Example README: `robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/README.md`
