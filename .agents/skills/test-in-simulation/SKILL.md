...
# Or with a specific scene (set ISAAC_SIM_SCENE in .env or override inline)
ISAAC_SIM_SCENE="omniverse://your-nucleus/path/to/scene.usd" airstack up isaac-sim robot
```
...
docker exec airstack-robot-1 bash -c "ros2 node list | grep robot"
