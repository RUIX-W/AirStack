...
- Any `Dockerfile` under `robot/`, `simulation/isaac-sim/`, `simulation/simple-sim/`, `gcs/`, or `common/`
...
- **Behavior on tag change:**
  ...
  2. `docker compose build` for profiles `robot,isaac-sim`.
