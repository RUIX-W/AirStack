...
- **Behavior Tree Framework:** `robot/ros_ws/src/autonomy/5_behavior/behavior_tree`
- **Behavior Executive:** `robot/ros_ws/src/autonomy/5_behavior/behavior_executive`
- **Example Nodes:** `robot/ros_ws/src/autonomy/5_behavior/behavior_tree_example`
...
ls -la robot/ros_ws/src/autonomy/5_behavior/behavior_tree/

# Study example nodes
cat robot/ros_ws/src/autonomy/5_behavior/behavior_tree_example/src/example_action.cpp
cat robot/ros_ws/src/autonomy/5_behavior/behavior_tree_example/src/example_condition.cpp
```
...
cd robot/ros_ws/src/autonomy/5_behavior/
...
- **AirStack Behavior:**
  - Framework: `robot/ros_ws/src/autonomy/5_behavior/behavior_tree/`
  - Executive: `robot/ros_ws/src/autonomy/5_behavior/behavior_executive/`
  - Examples: `robot/ros_ws/src/autonomy/5_behavior/behavior_tree_example/`
