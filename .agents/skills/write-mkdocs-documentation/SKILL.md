...
**Use cases:**
- Link to module READMEs: `robot/ros_ws/src/autonomy/3_local/b_planners/my_planner/README.md`
...
nav:
  - Robot:
      - Local Planners:
          - DROAN: robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/README.md
          - My Planner: robot/ros_ws/src/autonomy/3_local/b_planners/my_planner/README.md
```
...
**Example:** `robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/README.md`
...
**File paths:**
```markdown
Edit `robot/ros_ws/src/autonomy/3_local/planner/config.yaml`
```
...
**AirStack Examples:**
- Module README: `robot/ros_ws/src/autonomy/3_local/b_planners/droan_local_planner/README.md`
