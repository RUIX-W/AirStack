...
|-------|----------------|----------|
| Interface | interface_bringup | `robot/ros_ws/src/autonomy/0_interface/interface_bringup` |
| Sensors | sensors_bringup | `robot/ros_ws/src/autonomy/1_sensors/sensors_bringup` |
| Perception | perception_bringup | `robot/ros_ws/src/autonomy/2_perception/perception_bringup` |
| Local | local_bringup | `robot/ros_ws/src/autonomy/3_local/local_bringup` |
| Global | global_bringup | `robot/ros_ws/src/autonomy/4_global/global_bringup` |
| Behavior | behavior_bringup | `robot/ros_ws/src/autonomy/5_behavior/behavior_bringup` |
...
cat robot/ros_ws/src/autonomy/3_local/local_bringup/launch/local.launch.xml
```
...
vi robot/ros_ws/src/autonomy/3_local/local_bringup/package.xml
```
...
- **AirStack Launch Files:**
  - Top-level robot launch: `robot/ros_ws/src/robot_bringup/launch/robot.launch.xml`
  - Autonomy bringup: `robot/ros_ws/src/autonomy/autonomy_bringup/launch/autonomy.launch.xml`
  - Local layer: `robot/ros_ws/src/autonomy/3_local/local_bringup/launch/local.launch.xml`
  - Global layer: `robot/ros_ws/src/autonomy/4_global/global_bringup/launch/global.launch.xml`
  
- **ROS 2 Launch Documentation:**
  - [ROS 2 Launch Files](https://docs.ros.org/en/humble/Tutorials/Intermediate/Launch/Launch-Main.html)
  - [Launch XML Format](https://docs.ros.org/en/humble/Tutorials/Intermediate/Launch/Using-ROS2-Launch-For-Large-Projects.html)
